      ...
      <main className="flex-1 overflow-y-auto w-full pb-16">
        ...
        <div className="max-w-[1200px] mx-auto px-5 md:px-12 pt-12 md:pt-20 pb-12 md:pb-16">
          <div className="animate-in fade-in slide-in-from-bottom-3 duration-500">
            <span className="inline-flex items-center rounded-full bg-[#294eb1] px-5 py-2 md:px-6 md:py-2.5 text-[14px] md:text-[16px] font-semibold text-white tracking-wide mb-5 md:mb-6">
              Instawork Research
            </span>
