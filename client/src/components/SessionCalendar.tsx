              ...
              {selectedSessions.map((s) => (
                <div key={s.id} className="flex items-center justify-between gap-2 md:gap-4 px-4 py-3.5 md:px-6 md:py-5">
                  ...
                  <button
                    type="button"
                    onClick={() => onBook(s)}
                    className="shrink-0 text-[17px] font-semibold text-white bg-cta-gradient rounded-[8px] px-3 py-1.5 md:px-5 md:py-2.5 hover:brightness-105 active:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3351E6]/40"
                  >
                    {actionLabel}
                  </button>
                </div>
